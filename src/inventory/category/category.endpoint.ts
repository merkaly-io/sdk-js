...
namespace Category {
  export const find = (params?: FindCategoryValidator) => {
    return MerkalySDK.prototype.$axios.$get<CategoryReference[]>('/inventory/categories/', { params })
  ...
  export const read = (id: IdCategoryValidator) => {
    return MerkalySDK.prototype.$axios.$get<CategoryReference>('/inventory/categories/' + id)
      .then(category => plainToInstance(CategoryReference, category))
  }

  export const create = (payload: CreateCategoryValidator) => {
    return MerkalySDK.prototype.$axios.$post<CategoryReference>('/inventory/categories/', payload)
      .then(category => plainToInstance(CategoryReference, category))
  }

  export const update = (id: IdCategoryValidator, payload: UpdateCategoryValidator) => {
    return MerkalySDK.prototype.$axios.$patch<CategoryReference>('/inventory/categories/' + id, payload)
      .then(category => plainToInstance(CategoryReference, category))
  }

  export const remove = (id: IdCategoryValidator) => {
    return MerkalySDK.prototype.$axios.$delete<void>('/inventory/categories/' + id)
  }
}
